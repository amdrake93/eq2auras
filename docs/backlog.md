...
### SHIPPED (LIVE VERIFICATION PENDING) — slice 7: QoL knobs — 2026-07-05
**Merged untested — Alex to run the live script** (`docs/plans/2026-07-05-slice7-qol-knobs.md` Task 5) **before anything builds on top.** Critical checks: grow-flip doesn't move windows; grow-up pins the bottom edge; mid-drag expiry doesn't fight; spacing 0 = touching; LATE at base; label says "16 pt".
