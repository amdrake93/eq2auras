...
**Remaining for the Sunday 2026-07-12 raid** (the one thing solo can't prove): non-master suppression at raid scale — Blanket's 6s tick stream staying invisible under real stacking. Capture spike JSONLs (schema self-verifies via `master` + `instances`) and ferry to `spike-data/2026-07-12/`.
